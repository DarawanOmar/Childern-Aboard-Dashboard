...
export const localApi = `${process.env.NEXT_PUBLIC_LOCAL_API_URL}/`;
...
export const EndPoints = {
  ...
  table: {
    ...
    preReserveTable: (id: number) => `${api}table/pre/reservation/${id}`,
  ...
  invoice: {
    ...
    getOneInvoiceOrder: (id: number) => `${api}order/order/${id}`,
